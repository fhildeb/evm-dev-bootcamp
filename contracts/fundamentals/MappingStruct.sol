...
contract MappingStruct {
    ...
    function sendFunds() public payable{
        ...
        balanceReceived[msg.sender].payments[balanceReceived[msg.sender].numPayments] = newPayment;
        balanceReceived[msg.sender].numPayments++;
    }
    
    function withdrawFundsTo(address payable _receiver, uint _value) public {
        require(balanceReceived[msg.sender].totalBalance >= _value, "You do not have enough funds");
