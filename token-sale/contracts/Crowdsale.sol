...
import "./subcontracts/Context.sol";
import "./subcontracts/IERC20.sol";
import "./subcontracts/SafeMath.sol";
import "./subcontracts/SafeERC20.sol";
import "./subcontracts/ReentrancyGuard.sol";
...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    constructor (uint256 crate, address payable cwallet, IERC20 ctoken) {
        require(crate > 0, "Crowdsale: rate is 0");
        require(cwallet != address(0), "Crowdsale: wallet is the zero address");
        require(address(ctoken) != address(0), "Crowdsale: token is the zero address");
